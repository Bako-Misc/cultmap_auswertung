...
general <- data_all %>% select(., c("hf_tourist_einheimisch","hf_einheit","hf_einheit_ja",
                                    "hf_einheit_nein","hf_grenzverkehr","sdf_geschlecht","sdf_jahrgang", "te_tourist_einheimisch"))
...
```{r}
dp8 <- data_all %>% select(., c("te_einwohner_code","hf_tourist_einheimisch","sdf_wohnort")) %>%
  filter(., hf_tourist_einheimisch == "ja")

dp8$te_einwohner_code[dp8$te_einwohner_code = 1] <- "Als Einwohner/in Ihres Wohnortes"
dp8$te_einwohner_code[dp8$te_einwohner_code = 2] <- "Als Einwohner/in Ihres Wohnortes"
```
