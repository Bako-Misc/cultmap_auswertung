...
names(myColors) <- levels(dp1_eiheit$sdf_jahrgang)
...
p1 <- ggplot(data = dp1, aes(x = sdf_jahrgang, y = percent, fill = hf_einheit)) +
  ...
  ggtitle("Wahrnehmung der Bodensseeregion als eine Einheit (Einheimisch und Touristen)") + 
  theme(plot.title = element_text(size = 11, face = "bold"),legend.title = element_blank(), legend.position="bottom",
        axis.text.y = element_text(size = 10), axis.title.y = element_text(size = 10)) + css 
...
p1_ohne <- ggplot(data = dp1_ohne, aes(x = sdf_jahrgang, y = percent, fill = hf_einheit)) +
  ...
  ggtitle("Wahrnehmung der Bodensseeregion als eine Einheit (Einheimisch und Touristen)") + 
  theme(plot.title = element_text(size = 11, face = "bold"),legend.title = element_blank(), legend.position="bottom",
        axis.text.y = element_text(size = 10), axis.title.y = element_text(size = 10)) + css2 
